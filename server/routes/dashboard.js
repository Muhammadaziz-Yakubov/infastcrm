...
<<<<<<< HEAD
    // Students with payment due in next 3 days (excluding today)
    const paymentsDueSoon = await Student.find({
      next_payment_date: {
        $gte: tomorrow,
        $lte: threeDaysLater
      },
...
<<<<<<< HEAD
      paymentsDueSoonCount: paymentsDueSoon.length,
      paymentsDueSoonList: paymentsDueSoon,
=======
>>>>>>> f76e6b7a4f867ecdb448a60fb5faf9d6925d5c88
