...
const createDefaultAdmin = async () => {
  try {
    const adminEmail = process.env.DEFAULT_ADMIN_EMAIL || 'muhammadazizyaqubov2@gmail.com';
    const adminPassword = process.env.DEFAULT_ADMIN_PASSWORD || 'ChangeMePlease!';
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/infast-crm';
